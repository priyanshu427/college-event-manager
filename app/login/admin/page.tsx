...
import { ShieldCheck, ArrowLeft, BarChart3, ShieldAlert, Cpu, Lock } from 'lucide-react'
...
export const metadata = {
  title: 'System Admin Portal Login | Campus Pulse',
  description: 'Sign in to the Admin Portal for campus event oversight, user role approvals, and system metrics.',
}
