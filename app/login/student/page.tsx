...
import { GraduationCap, ArrowLeft, Ticket, CalendarDays, Sparkles, CheckCircle2 } from 'lucide-react'
...
export const metadata = {
  title: 'Student Portal Login | Campus Pulse',
  description: 'Sign in to your Student Portal to view events, access digital passes, and manage registrations.',
}
